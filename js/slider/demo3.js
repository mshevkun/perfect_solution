 ...
 */
{
    ...
    calculatePath(path = "initial") {
      if (path === "initial") {
        ...
        return {
          ...
          },${this.frameSize} ${this.rect.width},${this.rect.height} 0,${
            this.rect.height
          } Z`,
          step3: `M 0,0 0,${this.rect.height} ${this.rect.width},${
            ...
            this.rect.width - this.frameSize
          },${this.frameSize} ${this.rect.width - this.frameSize},${
    ...
    navigate(dir = "next") {
      ...
      const animateSlides = () => {
        return new Promise((resolve, reject) => {
          ...
          const newSlideImg = newSlide.querySelector(".slide__img-wrapper");
  ...
  imagesLoaded(".slide__img-wrapper", { background: true }, () =>
